...
export const idMessages: Record<MessageKey, string> = {
    ...
    'addChannel.rateLimitWindowSecondsLabel': 'Jendela (detik)',
    'addChannel.rateLimitWindowSecondsPlaceholder': 'Kosong = 60 detik',
    'addChannel.rateLimitWindowSecondsHint': 'Durasi jendela geser dalam detik. Contoh: RPM=50 + jendela=300 berarti "maksimal 50 request per 5 menit".',
