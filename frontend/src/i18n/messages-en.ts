...
export const enMessages: Record<MessageKey, string> = {
    ...
    'addChannel.rateLimitWindowSecondsLabel': 'Window (seconds)',
    'addChannel.rateLimitWindowSecondsPlaceholder': 'Empty = 60s',
    'addChannel.rateLimitWindowSecondsHint': 'Sliding window duration in seconds. Example: RPM=50 + window=300 means "max 50 requests per 5 minutes".',
